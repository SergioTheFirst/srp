...
def test_validate_accepts_public_url() -> None:
    ...
    # 203.0.113.0/24 = RFC 5737 TEST-NET-3: publicly routable in form, reserved for
    # docs, so no real host is named here (the ex-default IP was scrubbed repo-wide).
    validate_runtime_config(ClientConfig(server_url="http://203.0.113.10:8000"))  # no raise
