...
def test_fuse_defaults_medium_stays_none():
    # o5-A4 contract change: fusion used to fail-open absent medium to "wired". That
    # fabricated confidence the collector never reported -- an FDB edge with no medium
    # evidence must stay None (unknown) instead of a confidently wrong "wired".
