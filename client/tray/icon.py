...
ID_OWNER = 0xE005  # «Мои данные» (o5 блок F, F11)
...
class TrayIcon:
    ...
    def __init__(
        ...
        *,
        ...
        on_owner: Callable[[], None],
    ) -> None:
        try:
            # use_last_error=True: без него ctypes.get_last_error() всегда 0 и
            # диагностика ниже («CreateWindowExW failed (…)») ничего не сообщает.
    ...
    def _popup_menu(self) -> None:
        ...
        u.AppendMenuW(menu, MF_STRING, ID_OWNER, "Мои данные")
