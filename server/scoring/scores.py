...
def _risk_exposure(
    ...
    # WHEA как прямой драйвер риска удалён (решение W4.3/D6, см. server/scoring/
    # bayesian.py:10-15): исправленные ошибки WHEA -- преимущественно шум прошивки/
    # ASPM/PCIe, он давал систематические ложные «аппаратные» тревоги. Оставлять его
    # в risk_exposure означало держать ровно тот же ложняк на другой оси.
