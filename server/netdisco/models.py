...
class ResolvedLink:
    ...
    # A10: the local ifIndex on each end (from FDB/CDP evidence's local_if), so the
    # unified assembler can resolve link physics (speed_mbps/port_down) by ifIndex.
    a_if: Optional[int] = None
    b_if: Optional[int] = None
